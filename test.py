...
def is_relevant_question(prompt_input):
    relevant_keywords = [
        ...
        "prevention", "diet", "healthy living", "hospital", "illness", "pharmacy", "allergy", "pain", "surgery",
        "sick", "cancer", "heart", "blood pressure", "diabetes", "stroke", "asthma", "flu", "depression", "anxiety",
        "stress", "obesity", "chiropractor", "physical therapy", "occupational therapy", "speech therapy",
        "respiratory therapy", "radiation therapy", "chemotherapy", "virus", "bacteria", "immune system", "genetics",
        "hereditary", "digestion", "sleep", "insomnia", "fatigue", "weight loss", "weight gain", "lifestyle", "smoking",
        "alcohol", "addiction", "substance abuse", "pregnancy", "childbirth", "menopause", "aging", "senior health",
        "children's health", "infant health", "pediatric", "adolescent health", "elderly health", "prenatal care",
        "postnatal care", "vaccination", "STD", "STI", "HIV/AIDS", "sexual health", "contraception", "family planning",
        "men's health", "women's health", "reproductive health", "fertility", "infertility", "endocrinology", "urology",
        "neurology", "dermatology", "ophthalmology", "otolaryngology", "gastroenterology", "pulmonology", "cardiology",
        "rheumatology", "oncology", "hematology", "nephrology", "orthopedics", "psychiatry", "gynecology", "obstetrics",
        "dentistry", "oral health", "nutritionist", "dietitian", "nutrition counseling"
    ]
